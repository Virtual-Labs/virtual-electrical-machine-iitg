...
* Objective
  - To perform the Experiment of the Rotating Magnetic Field Behaviour in two coils
...
* Pre conditions
  - 1. Open the url vlabs.ac.in and vlabs home page is displayed 
    ...
    4. Select Rotating Magnetic Field Behaviour in two coils, a home page is displayed and click on List of experiments 1 link,  where a list of experiments will be displayed on the screen
  
* Post conditions
   - characteristics of a Rotating Magnetic Field Behaviour in two coils is displayed.
* Test Steps
  1. Click on  "Rotating Magnetic Field Behaviour in two coils" link.
